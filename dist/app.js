...
var _user$project$Main$loadAdventure = F3(
	function (title, startingEventId, events) {
		return {
			title: title,
			startingEvent: A2(_elm_lang$core$Dict$get, startingEventId, events),
			events: events
		};
	});
...
var _user$project$Main$viewDeadEndError = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('grid error-message')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('error-message-title')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Dead End')
				])),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('error-message-description')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('La aventura está mal formada. La acción que tomaste desencadena en un evento inexistente.')
				]))
		]));
var _user$project$Main$viewNoConnectionError = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('grid error-message')
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Hubo un problema')
				])),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$decodeAdventureLink = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Main$AdventureLink,
	A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['title']),
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['url']),
		_elm_lang$core$Json_Decode$string));
var _user$project$Main$decodeAdventureLinks = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['adventures']),
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeAdventureLink));
var _user$project$Main$Adventure = F3(
	function (a, b, c) {
		return {title: a, events: b, startingEvent: c};
	});
var _user$project$Main$Action = F2(
	function (a, b) {
		return {description: a, outputs: b};
	});
var _user$project$Main$decodeAction = A3(
...
var _user$project$Main$Event = F3(
	function (a, b, c) {
		return {title: a, description: b, actions: c};
	});
var _user$project$Main$decodeEvent = A4(
	_elm_lang$core$Json_Decode$object3,
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['actions']),
		_elm_lang$core$Json_Decode$list(_user$project$Main$decodeAction)));
var _user$project$Main$decodeAdventure = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Main$loadAdventure,
	A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['title']),
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['events']),
		_elm_lang$core$Json_Decode$dict(_user$project$Main$decodeEvent)));
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {adventureLinks: a, route: b, selectedAdventure: c, currentEvent: d};
	});
var _user$project$Main$NoConnectionError = {ctor: 'NoConnectionError'};
var _user$project$Main$PlayingAdventure = {ctor: 'PlayingAdventure'};
var _user$project$Main$ListingAdventures = {ctor: 'ListingAdventures'};
var _user$project$Main$StartAgain = function (a) {
	return {ctor: 'StartAgain', _0: a};
};
var _user$project$Main$ListAdventureLinks = {ctor: 'ListAdventureLinks'};
var _user$project$Main$viewNavbar = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('navbar-logo'),
					_elm_lang$html$Html_Events$onClick(_user$project$Main$ListAdventureLinks)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Ramitas')
				]))
		]));
var _user$project$Main$viewEnd = function (adventure) {
	return A2(
		_elm_lang$html$Html$pre,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('adventure-end')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('La aventura ha finalizado.')
					])),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn btn-block'),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$StartAgain(adventure))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Comenzar de nuevo')
					])),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Ver listado de aventuras')
					]))
			]));
};
var _user$project$Main$SetEvent = F2(
	function (a, b) {
		return {ctor: 'SetEvent', _0: a, _1: b};
	});
var _user$project$Main$RollAction = function (a) {
	return {ctor: 'RollAction', _0: a};
};
var _user$project$Main$viewAction = function (action) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$RollAction(action)),
						_elm_lang$html$Html_Attributes$class('btn btn-outline btn-block')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(action.description)
					]))
			]));
};
var _user$project$Main$viewActions = F2(
	function (adventure, actions) {
		return _elm_lang$core$List$isEmpty(actions) ? _user$project$Main$viewEnd(adventure) : A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$List$map, _user$project$Main$viewAction, actions));
	});
var _user$project$Main$viewEvent = F2(
	function (adventure, maybeEvent) {
		var _p0 = maybeEvent;
		if (_p0.ctor === 'Just') {
			var _p1 = _p0._0;
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('adventure-event-title')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('adventure-event-description')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p1.description)
							])),
						A2(_user$project$Main$viewActions, adventure, _p1.actions)
					]));
		} else {
			return _user$project$Main$viewDeadEndError;
		}
	});
var _user$project$Main$viewAdventure = F2(
	function (maybeAdventure, maybeCurrentEvent) {
		var _p2 = maybeAdventure;
		if (_p2.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('grid adventure')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('adventure-title')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p3.title)
							])),
						A2(_user$project$Main$viewEvent, _p3, maybeCurrentEvent)
					]));
		}
	});
...
var _user$project$Main$FetchAdventureSucceed = function (a) {
	return {ctor: 'FetchAdventureSucceed', _0: a};
};
var _user$project$Main$getAdventure = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$FetchFail,
		_user$project$Main$FetchAdventureSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Main$decodeAdventure, url));
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'FetchAdventureLinksSucceed':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{adventureLinks: _p4._0});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'FetchFail':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{route: _user$project$Main$NoConnectionError});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SelectAdventure':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$getAdventure(_p4._0.url)
				};
			case 'FetchAdventureSucceed':
				var _p5 = _p4._0;
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						route: _user$project$Main$PlayingAdventure,
						selectedAdventure: _elm_lang$core$Maybe$Just(_p5),
						currentEvent: _p5.startingEvent
					});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SetEvent':
				var _p6 = model.selectedAdventure;
				if (_p6.ctor === 'Nothing') {
			...
			case 'RollAction':
				var array = _elm_lang$core$Array$fromList(_p4._0.outputs);
				var length = _elm_lang$core$Array$length(array);
				var randomIndex = A2(_elm_lang$core$Random$int, 0, length - 1);
				var cmd = A2(
					_elm_lang$core$Random$generate,
					_user$project$Main$SetEvent(array),
					randomIndex);
				return {ctor: '_Tuple2', _0: model, _1: cmd};
			case 'ListAdventureLinks':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{route: _user$project$Main$ListingAdventures});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{currentEvent: _p4._0.startingEvent});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$FetchAdventureLinksSucceed = function (a) {
	return {ctor: 'FetchAdventureLinksSucceed', _0: a};
};
var _user$project$Main$getAdventureLinks = function () {
	var url = './adventures/index.json';
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$FetchFail,
		_user$project$Main$FetchAdventureLinksSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Main$decodeAdventureLinks, url));
}();
var _user$project$Main$init = function () {
	var model = {
		adventureLinks: _elm_lang$core$Native_List.fromArray(
			[]),
		route: _user$project$Main$ListingAdventures,
		selectedAdventure: _elm_lang$core$Maybe$Nothing,
		currentEvent: _elm_lang$core$Maybe$Nothing
	};
	return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getAdventureLinks};
}();
var _user$project$Main$SelectAdventure = function (a) {
	return {ctor: 'SelectAdventure', _0: a};
};
var _user$project$Main$viewAdventureLink = function (adventureLink) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('adventure-link')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$SelectAdventure(adventureLink))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(adventureLink.title)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('adventure-link-description')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(adventureLink.description)
					]))
			]));
};
var _user$project$Main$viewAdventureLinks = function (adventureLinks) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('splash-image')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('splash-title')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Aventuras')
									]))
							]))
					])),
				A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									...
									function (link) {
										return row(
											_user$project$Main$viewAdventureLink(link));
									},
									adventureLinks))
							]))
					]))
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						var _p7 = model.route;
						switch (_p7.ctor) {
							case 'ListingAdventures':
								return _user$project$Main$viewAdventureLinks(model.adventureLinks);
							case 'PlayingAdventure':
								return A2(_user$project$Main$viewAdventure, model.selectedAdventure, model.currentEvent);
							default:
								return _user$project$Main$viewNoConnectionError;
						}
					}()
					]))
			]));
